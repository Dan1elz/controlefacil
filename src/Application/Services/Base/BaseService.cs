...
namespace ControleFacil.src.Application.Services.Base
{
    public class BaseService<TEntity, TRepository>(TRepository repository, ApplicationDbContext context) where TEntity : class where TRepository : IBaseRepository<TEntity>
    {
        ...
        public virtual async Task<TEntity> GetByIdAsync(int Id, CancellationToken ct) //GET{}
        {
        ...
        public virtual async Task DeleteAsync(int Id, CancellationToken ct) //DELETE
        {
        ...
        public virtual Task DeleteRangeAsync(List<int> Ids, CancellationToken ct)
        {
            List<Task> tasks = [];
        ...
        public virtual Task<TEntity> UpdateAsync(int Id, TEntity entity, CancellationToken ct) //PUT
        {
